...
bg_path = "/nethome/ssinha97/mv3d/data/bg_imagenet/val"
bam_path = "/nethome/ssinha97/mv3d/data/obj_cars"
...
def main(argv=None):
    ...
    if normal_test is True:
        models_file = "/nethome/ssinha97/mv3d/data/cars_test_normal.txt"
        output_path = "/nethome/ssinha97/mv3d/data/test_normal_rendered"
    else:
        models_file = "/nethome/ssinha97/mv3d/data/cars_test_difficult.txt"
        output_path = "/nethome/ssinha97/mv3d/data/test_difficult_rendered"
